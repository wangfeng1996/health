...
public class MessageConstant {
    public static final String DELETE_CHECKITEM_FAIL = "删除检查项失败,原因:当前检查项被引用,不能被删除";
    ...
    public static final String EDIT_QUERY_CHECKITEM_FAIL = "失败";
    public static final String EDIT_QUERY_CHECKITEM_SUCCESS = "成功";
}
